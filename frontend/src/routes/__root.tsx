...
import { NodeProvider } from "@/hooks/use-node-context";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Smart Home Control | Cổng IoT ESP32-S3" },
      { name: "twitter:description", content: "Bảng điều khiển giám sát và điều khiển Smart Home qua cổng IoT ESP32-S3: cảm biến, thiết bị, lịch sử và cài đặt ngưỡng tự động." },
    ],
    links: [
      {
        rel: "stylesheet",
